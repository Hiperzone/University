...
enum TIPO_MOVIMENTO
{
	TIPO_MOVIMENTO_DEBITO = 0,
	TIPO_MOVIMENTO_CREDITO = 1
};
...
enum OPCODES
{
	...
	SMSG_CONGELAR_CONTA_RESPONSE,
	SMSG_DESCONGELAR_CONTA_RESPONSE,
	NUM_MENSAGENS
};
...
void msg_listar_servicos_handler(int scocket, mensagem_s *msg);
